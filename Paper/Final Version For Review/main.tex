...
\begin{IEEEkeywords}
Power systems, graph neural networks, self-supervised learning, cascading failures, power flow, optimal power flow, explainability, physics-informed machine learning
\end{IEEEkeywords}
