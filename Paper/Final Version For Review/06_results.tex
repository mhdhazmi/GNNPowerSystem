...
\caption{IEEE 118-bus cascade prediction: SSL dramatically reduces training variance at 10\% labels (Â±0.051 vs Â±0.243), providing stable convergence across random seeds.}
